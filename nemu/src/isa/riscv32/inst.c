...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("0100000 ????? ????? 101 ????? 01100 11", sra    , I, R(rd) = SEXT(src1,32) >> (src2 & 0x1F));
  ...
  INSTPAT("0000001 ????? ????? 001 ????? 01100 11", mulh   , R, R(rd) = SEXT(src1,32)*SEXT(src2,32) >> 32);//乘法指令取高32位 
                                                                                                          //printf("rs1: %ld,  rs2: %d, R(rd): %ld\n",SEXT(src1,32),src2,SEXT(src1,32)*SEXT(src2,32) >> 32);
