...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("0000001 ????? ????? 001 ????? 01100 11", mulh   , R, printf("src1 = 0x%0x,src2 = 0x%0x,src1*src2 = 0x%0lx\n",(sword_t)src1,(sword_t)src2,SEXT(src1*src2,64) >> 32);R(rd) = SEXT(src1*src2,64) >> 32);//乘法指令取高32位
